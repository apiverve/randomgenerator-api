# Random Data Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:randomgenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.randomgenerator.RandomDataGeneratorAPIClient;
import com.apiverve.randomgenerator.APIResponse;
import com.apiverve.randomgenerator.APIException;

// Initialize the client
RandomDataGeneratorAPIClient client = new RandomDataGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/randomgenerator](https://docs.apiverve.com/ref/randomgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/randomgenerator](https://docs.apiverve.com/ref/randomgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/randomgenerator-api/issues)
